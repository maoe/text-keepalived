...
netmaskToOct (Netmask w8) = toOctets w32
...
-- common utils
toOctets :: Word32 -> String
toOctets w32 = concat $ intersperse "." $ map show [o1, o2, o3, o4]
